        ...
        <div className="footer_content">
            ...
            <div className="footer_div">
                ...
                <div className="footer_email">
                    ...
                    <a href="https://outlook.live.com" className="footer__a">juegueteriaCosmica@outlook.com</a>
                </div>
                <div className="footer_phone">
                    <span className="footer__span footer__span-phone"></span>
                    <a href="https://web.whatsapp.com/" className="footer__a">(221)456789</a>
                </div>
            </div>
            <div className="footer_div footer_div-social">
                <h3 className="footer_h3">Redes</h3>
                <div className="footer_social">
                    <a href="https://www.instagram.com/" className="footer__a footer__a-ig" aria-label='link to instagram'></a>
                    <a href="https://www.facebook.com/" className="footer__a footer__a-fb" aria-label='link to facebook'></a>
                    <a href="https://www.tiktok.com/" className="footer__a footer__a-tk" aria-label='link to tiktok'></a>
                </div>
            </div>
            <iframe
